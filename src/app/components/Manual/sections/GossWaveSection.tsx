...
const GossWaveSection = () => {
    ...
    const generateContractPhrases = () => {
        return [
            ...
            `gov Требования: Опрятный внешний вид, 5-ти летняя прописка, паспорт, медицинская карта и военный билет.`,
            ...
            `gov Вам требуется: иметь опрятный внешний вид, прописку от 5 лет, иметь при себе медицинскую карточку и военный билет!`,
