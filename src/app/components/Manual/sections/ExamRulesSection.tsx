    ...
    return (
        <>
            ...
            <div className="subsection">
                ...
                <ExamplePhrase
                    text="Начало: say Сейчас пройдет экзамен на знание Уставной Документации Министерства Обороны!"/>
                <ExamplePhrase
                    text="Конец: say Экзамен на знание Уставной Документации Министерства Обороны успешно сдан!"/>
                <div className="note">
