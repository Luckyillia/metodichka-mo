    ...
    return (
        <>
            ...
            <div className="subsection">
                ...
                <ExamplePhrase
                    text="say Сейчас пройдет экзамен на знание Уставной Документации Министерства Обороны!"/>
                <div className="note">
                ...
                <ExamplePhrase
                    text="say Экзамен на знание Уставной Документации Министерства Обороны успешно сдан!"/>
                <div className="note">
            ...
            <div className="subsection">
                ...
                <ExamplePhrase text="say Сейчас пройдет экзамен на знание Трудового Этикета!"/>
                <div className="note">
                    <strong>📌 Примечание:</strong> После чего вы задаете от 3 до 6 вопрос по данному разделу
                </div>
                <div className="note">
                ...
                <ExamplePhrase text="say Экзамен на знание Трудового Этикета успешно сдан!"/>
                <div className="note">
                    <strong>📸 Примечание:</strong> У сотрудника должно быть три фотокарточки (скриншота), о начале,
                    середине и конце экзамена.
                </div>
            ...
            <div className="subsection">
                ...
                <ExamplePhrase text="say Сейчас пройдет сдача присяги Министерства Обороны!"/>
                <div className="note">
                ...
                <ExamplePhrase text="say На этом сдача присяги Министерства Обороны окончена!"/>
                <div className="note">
